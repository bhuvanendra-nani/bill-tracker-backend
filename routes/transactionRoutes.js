...
router.put("/:id", authMiddleware, upload.single("photo"), async (req, res) => {
  try {
    ...
    existingTransaction.dueDate = dueDate ?? existingTransaction.dueDate;
...
router.put(
  ...
  async (req, res) => {
    try {
      ...
      existingTransaction.voiceNote = `${req.protocol}://${req.get(
        "host"
      )}/uploads/voice-notes/${req.file.filename}`;
